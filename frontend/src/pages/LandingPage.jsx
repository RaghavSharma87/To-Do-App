...
/**
 * LandingPage - Minimalist intro page matching the "White Lines" design.
 * Uses the custom defined theme variables for consistent off-white styling.
 */
function Landing() {
  const navigate = useNavigate();

  // Dynamically generated SVG wave pattern background
  ...
  return (
    <div
      className="min-h-screen font-sans bg-background selection:bg-border-subtle overflow-hidden relative"
      style={{
    ...
    >
      ...
      {/* Hero Section */}
      <main className="relative z-10 flex flex-col justify-center items-start min-h-screen max-w-7xl mx-auto px-6 pt-20">
        <div className="flex flex-col gap-6 max-w-2xl">
          {/* Main Headline */}
          <h2 className="text-6xl md:text-8xl font-bold tracking-tighter leading-[0.85] text-text-main font-serif animate-slide-up">
            Minimalist
            <br />
            <span className="text-text-muted/50 italic font-light">To-Do</span>
          </h2>
          ...
          <div className="animate-slide-up animation-delay-300">
            <button
              ...
              className="group relative flex items-center gap-3 mt-4 bg-primary text-background px-10 py-4 rounded-full text-base font-semibold hover:bg-primary-hover transition-all shadow-lg overflow-hidden"
            >
